...
export class UpdatePrice extends React.Component<{ userId: number, priceId: number }, { amount: string, details: string, order: string }>
{
    ...
    postData() {
        var cats: any;
        var newPriceInstance = { priceId: this.props.priceId, details: this.state.details, amount: this.state.amount, order: this.state.order, userId: this.props.userId }
        ...
        return (
            <div className='AddPrice'>
                <div className="col col-md-10">
                    <h2>
                        Change the price of your category
                    </h2>
                    <form>
                        ...
                        <div className="spacing">
                            <button className="btn blue-button" onClick={this.handleSubmit}>Change the price!</button>
                        </div>
                    </form>
                </div>
            </div>
